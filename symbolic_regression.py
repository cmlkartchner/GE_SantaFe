...
from deap import base, creator, tools, gp, generate
...
'''
    - Fitness: how well an individual meets the qualifications to solve the problem
'''
creator.create("Minimum fitness: ", base.Fitness, weights = (-1.0,))
creator.create("Maximum fitness: ", base.Fitness, weights = (1.0,))

toolbox = base.Toolbox()
toolbox.register("expr", generate, rules = rules, max_depth = 10)

def eval_genetic_expression():
