...
FITNESS_FOOD_UPPER_THRESHOLD = 0.7
FITNESS_FOOD_LOWER_THRESHOLD = 0.5

POPULATION_TOLERANCE = .4

CROSSOVER_PRODUCTION = 3
NOVELTY_TOLERANCE_FOOD = .85
NOVELTY_TOLERANCE_OFFPATH = .5
